# -*- coding: utf-8 -*-
#
# bic documentation build configuration file, created by
...
project = u'Berkeley Brain Imaging Center'
copyright = u'2016, Berkeley Brain Imaging Center'
...
#html_theme_options = {}
html_theme_options = {
    'description': 'Berkeley Brain Imaging Center',
    'github_button': False,
    'extra_nav_links': {"Home page": 'http://bic.berkeley.edu'}
}
...
html_title = u"Berkeley Brain Imaging Center"
...
texinfo_documents = [
  (master_doc, 'bic', html_title,
   author, 'bic', 'One line description of project.',
   'Miscellaneous'),
]
